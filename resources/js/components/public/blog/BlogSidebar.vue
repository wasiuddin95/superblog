    ...
    <span id="sidebar">
        <div class="span4">
            ...
            <div class="widget">
                ...
                <input placeholder="Type something" v-model="keyword" @keyup="RealSearch"
            ...
            <div class="widget">
                ...
                <ul class="recent">
                    <li v-for="(post,index) in blogpost" v-if="index<5">
                        <img :src="`uploadimage/${post.photo}`" class="pull-left" width="80" height="50" alt="" />
                        <h6><router-link :to="`/blog/${post.id}`">{{post.title | sortlength(60,"....")}}</router-link></h6>
                        <p>
